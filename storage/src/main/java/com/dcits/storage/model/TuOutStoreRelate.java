...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "PR_OUTSTORE_REVERSE_RELATE", procedureName = "PR_OUTSTORE_REVERSE_RELATE", parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "OUT_STORE_NO", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "BAR_CODE", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "LOCATION_NO", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "USER_NAME", type = String.class) }) })
public class TuOutStoreRelate implements Serializable {
